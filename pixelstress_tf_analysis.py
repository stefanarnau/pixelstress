...
for dataset in datasets:
    ...
    # Apply baseline
    ersp_close.apply_baseline((-1.5, -1.2), mode='zscore', verbose=None).crop(tmin=-1.5,tmax=1)
    ersp_below.apply_baseline((-1.5, -1.2), mode='zscore', verbose=None).crop(tmin=-1.5,tmax=1)
    ersp_above.apply_baseline((-1.5, -1.2), mode='zscore', verbose=None).crop(tmin=-1.5,tmax=1)
...
a = mne.grand_average(ersps_close)
a.plot_joint()

b = mne.grand_average(ersps_below)
b.plot_joint()


c = mne.grand_average(ersps_above)
c.plot_joint()
